...
/**
 * Servlet implementation class DisplaySelectedArticle
 */
@WebServlet("/DisplaySelectedArticle")
public class DisplaySelectedArticle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplaySelectedArticle() {
        super();
	...
	//	request.setAttribute("artList", articleDetail);
		...
		RequestDispatcher rd = request.getRequestDispatcher("displaySelectedArticle.jsp");
