...
/**
 * Servlet implementation class DesktopLocationSelectedArticle
 */
@WebServlet("/DesktopLocationSelectedArticle")
public class DesktopLocationSelectedArticle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DesktopLocationSelectedArticle() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//String v = request.getParameter("ee");
	...
	//	request.setAttribute("artList", articleDetail);
		...
		RequestDispatcher rd = request.getRequestDispatcher("desktopLocationSelectedArticle.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(legit.equals("Post to Main Page")){
	        ...
	        RequestDispatcher rd = request.getRequestDispatcher("DesktopLatestArticle");
	        rd.forward(request,response);
		}
		else if(legit.equals("Discard")){
