...
/**
 * Servlet implementation class DesktopLatestSelectedArticle
 */
@WebServlet("/DesktopLatestSelectedArticle")
public class DesktopLatestSelectedArticle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DesktopLatestSelectedArticle() {
        super();
	...
	//	request.setAttribute("artList", articleDetail);
		...
		RequestDispatcher rd = request.getRequestDispatcher("desktopLatestSelectedArticle.jsp");
