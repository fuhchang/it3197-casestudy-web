...
/**
 * Servlet implementation class ArticleSend
 */
@WebServlet("/ArticleSend")
public class ArticleSend extends HttpServlet {
	...
	//	System.out.println("Article Date: " + articleSubmittedDate);
		...
		String msg = "A resident submitted the following on " +articleSubmittedDate + ": \n\n\"" + content + "\" \n\nLocation: \n" + location + ".\n(Coordinates: " + dbLat + ", " + dbLon+ "). \n\nResident's Detail: \nName: " + articleUserName+"\nContact Number: " + articleUserPhone +"\nEmail: "+ articleUserEmail +"\n\nThank you.\nNanyang Polytechnic Town Council \nContact Number: 65551242 \nEmail: NYPTC@mail.com";
		...
		RequestDispatcher rd = request.getRequestDispatcher("articleE.jsp");
		...
		if(email.send("IT3161GeoVizAssignment@gmail.com" , "123841N@mymail.nyp.edu.sg", subject, message)==true){
			System.out.println("Successfully sent!");
			       ...
			       try{
					...
					RequestDispatcher rd = request.getRequestDispatcher("DesktopFeedbackArticle");
					rd.forward(request,response);
