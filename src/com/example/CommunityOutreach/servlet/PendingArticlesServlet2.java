...
/**
 * Servlet implementation class PendingArticlesServlet2
 */
@WebServlet("/PendingArticlesServlet2")
public class PendingArticlesServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PendingArticlesServlet2() {
        super();
        ...
        if(request.getParameter("distSelected").equals("")||request.getParameter("currentLat").equals("")||request.getParameter("currentLon").equals("")){
	       // RequestDispatcher rd = request.getRequestDispatcher("articleDisplayMainMobileView.jsp");
			...
			currentLon = Double.parseDouble(request.getParameter("currentLon"));
				...
				List<Article> artList = am.retrieveAllPendingArticlesWithinDistance(currentLat, currentLon, distSelected);
