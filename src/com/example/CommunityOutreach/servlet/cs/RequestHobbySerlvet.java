...
/**
 * Servlet implementation class RequestHobbySerlvet
 */
@WebServlet("/RequestHobbySerlvet")
public class RequestHobbySerlvet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RequestHobbySerlvet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		requestList = rhm.getAllRequest(eventID);
