...
/**
 * Servlet implementation class PendingArticlesServlet3
 */
@WebServlet("/PendingArticlesServlet3")
public class PendingArticlesServlet3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PendingArticlesServlet3() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Article> fb = am.retrieveAllPendingFeedbackArticlesWithinDistance(currentLat, currentLon, distSelected);
		List<Article> loc = am.retrieveAllPendingLocationArticlesWithinDistance(currentLat, currentLon, distSelected);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("pendingArticlesStats.jsp");
