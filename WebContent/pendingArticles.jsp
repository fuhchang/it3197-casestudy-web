	...
	<br />
	 ...
	 <div class="panel panel-info" Style="width:100%;margin:0px auto;">
		...
		<div class="panel-body" Style="width:100%; " >
				...
				<hr/>
				<form action="PendingArticlesServlet2" method="post">
				...
				<a type="submit" class="pull-right" href="PendingArticlesServlet3?currentLat=${currentLat}&currentLon=${currentLon}&distSelected=${selectedDist}" id="showArtLoc" name="article-content-id"><h4><u><b>View Article Locations</b></u></h4></a>
				<br id="brrr"/>
							...
							<c:forEach items="${artList}" var="item">
									<tr>
										...
										<td>
											...
											${item.articleDate}
											<br/>
											<div style="color:#088A08;">Category: ${item.category }</div>
											...
											<br/>
											<a type="submit" href="TCDisplaySelectedArticle?id=${item.articleID }" id="" name="article-content-id"><u>Read More</u></a>
