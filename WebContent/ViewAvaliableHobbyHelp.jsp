	...
	<jsp:attribute name="content">
		...
		<table class="table table-striped" id="grpTable2"> 
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><spansm></button>
								<h3>${item.grpName}</h3>
							</div>
            ...
            <input type="hidden" id="id" value="${item.grpID}">
                <p>Start Date: <input type="text" id="datepicker" name="date1" readonly></p>
                <br>
             	To
             	<br>
             	<p>End Date: <input type="text" id="datepicker1" name="date2" readonly></p>
            </div>
        </div>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary" id="requestHobby" onclick="sendData()">Request</button>
							</div>
					    </div>
					</div>
				</div>
